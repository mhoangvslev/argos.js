...
declare type ProviderType = ethers.providers.BaseProvider;
declare type ContractType = ethers.Contract;
declare type NodeType = Neode.Node<any>;
declare type DatabaseConstructorType = Neo4JConstructor;
declare type PathFindingAlgorithmParam = {
    algo: PathFindingAlgorithmEnum.MinimumWeightSpanningTree;
    param: MinimumWeightSpanningTreeAlgorithmParam;
} | {
    algo: PathFindingAlgorithmEnum.ShortestPath;
    param: ShortestPathAlgorithmParam;
} | {
    algo: PathFindingAlgorithmEnum.SingleSourceShortestPath;
    param: SingleSourceShortestPathAlgorithmParam;
} | {
    algo: PathFindingAlgorithmEnum.AllPairsShortestPath;
    param: AllShortestPathAlgorithmParam;
} | {
    algo: PathFindingAlgorithmEnum.AStar;
    param: AStarAlgorithmParam;
} | {
    algo: PathFindingAlgorithmEnum.KShortestPath;
    param: KShortestPathsAlgorithmParam;
} | {
    algo: PathFindingAlgorithmEnum.RandomWalk;
    param: RandomWalkAlgorithmParam;
} | {
    algo: PathFindingAlgorithmEnum.None;
    param: any;
};
...
export declare const enum CommunityDetectionAlgoritmEnum {
    Louvain = "Louvain",
...
export declare const enum CentralityAlgorithmEnum {
    PageRank = "PageRank",
...
export declare const enum PathFindingAlgorithmEnum {
...
export interface DatabaseModel {
    [alias: string]: Neode.SchemaObject;
}
